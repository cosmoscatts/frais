...
<template>
  <div>
    <n-grid :cols="8" :x-gap="8" :y-gap="12">
      <n-grid-item v-for="color in themeColorList" :key="color" flex-x-center>
    ...
    >
      ...
      <n-tabs>
        <n-tab-pane v-for="item in traditionalColorList" :key="item.label" :name="item.label" :tab="item.label">
